    ...
    <section style={{ background: '#EDE8DF', padding: '5rem 5%' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2.5rem', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <Link href="/deals" style={{ fontWeight: 600, color: '#1B4332', textDecoration: 'none', fontSize: '0.95rem', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
            Browse all deals
          </Link>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '2.5rem' }}>
          ...
          <p style={{ marginTop: '0.85rem', fontSize: '0.82rem', color: '#7A736C' }}>
            47 live deals across mobile and internet
          </p>
        </div>
      </div>
    </section>
